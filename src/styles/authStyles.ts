...
export const authStyles = StyleSheet.create({
  ...
  // Mobile-specific overrides for OrganizerSignUpFlow
  signupMobileBusinessTypeContainer: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    justifyContent: 'space-between',
    marginBottom: 16,
  ...
  signupMobileBusinessTypeOption: {
    width: '48%',
